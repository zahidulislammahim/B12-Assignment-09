...
const Contact = () => {
  return (
    <div className="relative">
      <img
        src="https://lh3.googleusercontent.com/u0VmmFxdNgE75u4ES6mxNQKiS5v-flZ0D9e3oSeVQd8wLupTKGS3XCRkym7t2hLwnxEHJj_mFHK2Opze0EBmS6bWdnJ8Q5KRdH8=s0-e365"
        className="w-full h-full object-cover absolute -z-50 opacity-10"
      />
      <form className="flex flex-col items-center text-sm py-5 w-10/12 mx-auto">
        <title>Contact</title>
        ...
        <p className="text-sm text-gray-500 text-center pb-10 w-100">
          Have any questions or suggestions? Feel free to reach out to us. We’re
          always happy to hear from you and will respond as soon as possible.
        </p>
